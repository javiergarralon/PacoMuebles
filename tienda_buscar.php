  ...
  <div class="d-flex" id="wrapper">
    ...
    <!--PHP BUSCAR TIENDAS-->
      ...
      if(isset($_POST['searchBtn'])){
        ...
        $select = "SELECT * FROM TIENDAS WHERE ".$filtro." like '%".$campo."%'";
    ...
    <!-- Lista de tiendas buscadas-->
      <div class="container my-5">       
        <div class="d-flex justify-content-center">
          <img src="img/tiendas.png">
        </div>
        <form class="form py-2 color_font" action="tienda_buscar.php" method="post">
          <div class="container form-row d-flex justify-content-center mb-3">
            <div class=" form-group col-md-2 col-sm-3 m-0">
              <label for="searchFilter">Filtro:</label>
                <select class="custom-select color_font" name="searchFilter">
              ...
              <div class="form-group col-md-2 col-sm-3 m-0">
                ...
                <select class="custom-select color_font" name="searchActivity">
          ...
          <div class="container d-flex  justify-content-center mt-2">
            <a class="btn color_text bg-warning" href="tienda_home.php"><i class="fas fa-arrow-left"></i></a>            
          </div>
      </div>      
    </div>
  </div>
