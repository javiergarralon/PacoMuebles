    ...
    <div id="page-content-wrapper">
     ...
     <!-- /#navbar -->
      ...
      <div class="container my-5"> 
        <h1 class="color_font font-weight-bold text-center">Usuarios</h1>
        <div class="d-flex justify-content-center mb-md-5">
          <img src="img/usuarios.png" style="width:165px">
        </div>
        <hr>
        <div class="d-flex justify-content-around my-5">
          <a href="usuario_add.php" title="Nuevo"><button class="btn color_use text-warning px-md-4 py-md-4 px-xs-3 py-xs-3"><img src="img/plus.png" style="width:100px"></button></a>
