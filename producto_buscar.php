  ...
  <div class="d-flex" id="wrapper">
    ...
    <!--PHP BUSCAR PRODUCTOS-->
      <?php   
        if(isset($_POST['searchBtn'])){
          ...
          $select = "SELECT * FROM PRODUCTOS WHERE ".$filtro." like '%".$campo."%'";
    ...
    <!-- Lista de PRODUCTOS buscados-->
      <div class="container my-5">       
        ...
        <form class="form color_font py-2" action="producto_buscar.php" method="post">
        ...
        <div class="container d-flex  justify-content-center mt-2">
          <a class="btn color_text bg-warning" href="producto_home.php"><i class="fas fa-arrow-left"></i></a>            
        </div>
      </div>      
    </div>
  </div>
