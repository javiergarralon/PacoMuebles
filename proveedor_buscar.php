...
<body onload="hora_act()">
  ...
  <div class="d-flex" id="wrapper">
    ...
    <!--PHP BUSCAR proveedores-->
      <?php   
        if(isset($_POST['searchBtn'])){
          include_once 'conexion.php'; 
          $filtro = $_POST['searchFilter'];
          $estado = $_POST['searchActivity'];
          $campo = strtoupper($_POST['inputSearch']);

          $consulta = "";
          $select = "";

          $select = "SELECT * FROM PROVEEDORES WHERE ".$filtro." like '%".$campo."%'";
          ...
          echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                  <strong>Resultados con: '.$campo.' | Filtro: '.$filtro.' | Estado: '.$estado.'</strong> 
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>';
      ...
      <div class="container my-5 color_font">       
        ...
        <form class="form py-2" action="proveedor_buscar.php" method="post">
          <div class="container form-row d-flex justify-content-center mb-3">
            ...
            <div class="form-group col-md-2 col-sm-3 m-0">
              <label for="searchActivity">Estado:</label>
        ...
        <table class="table table-striped table-hover text-center color_font" id="tabla_modal">
          <thead>
        ...
        <div class="container d-flex  justify-content-center mt-2">
          <a class="btn color_text bg-warning" href="proveedor_home.php"><i class="fas fa-arrow-left"></i></a>            
        </div>
      </div>      
    </div>
  </div>
