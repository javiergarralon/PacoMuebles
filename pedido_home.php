    ...
    <div id="page-content-wrapper">
     ...
     <!-- /#navbar -->
      ...
      <div class="container my-5"> 
        <h1 class="color_font font-weight-bold text-center">Pedidos</h1>
        <div class="d-flex justify-content-center mb-5">          
          <img src="img/pedidos.png" style="width:165px">
        </div>
        <hr>
        <div class="d-flex justify-content-around my-5 row">
          <a href="pedidos.php"><button class="btn color_use text-warning px-md-4 py-md-4 px-xs-3 py-xs-3" title="Nuevo"><img src="img/plus.png" style="width:100px"></button></a>
          <form action="pedido_buscar.php" method="POST">
