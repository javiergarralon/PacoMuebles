  ...
  <div class="d-flex" id="wrapper">
    ...
    <!--PHP BUSCAR USUARIOS-->
      ...
      if(isset($_POST['searchBtn'])){
            ...
            $permiso = $_POST['searchActivity'];
            $campo = strtolower($_POST['inputSearch']);

            $consulta = "";
            $select = "";

            $select = "SELECT * FROM USUARIOS WHERE USER like '%".$campo."%' ORDER BY PERMISSION DESC";

            if($permiso == ''){
                $consulta = $select;
            }else{
                $where = " AND PERMISSION = ".$permiso;
            ...
            echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong>Resultados con: '.$campo.' | Permisos: '.$permiso.'</strong> 
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>';
    ...
    <!-- Lista de USUARIOS buscados-->
      <div class="container my-5">       
        ...
        <form class="form color_font py-2" action="producto_buscar.php" method="post">
          <div class="container form-row d-flex justify-content-center mb-3">
            <div class=" form-group col-md-4 m-0">
              <label for="searchActivity">Filtro:</label>
        ...
        <div class="container d-flex  justify-content-center mt-2">
          <a class="btn color_text bg-warning" href="usuarios.php"><i class="fas fa-arrow-left"></i></a>            
        </div>
      </div>      
    </div>
  </div>
