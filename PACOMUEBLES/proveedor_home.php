  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
     ...
     <!-- /#navbar -->
      ...
      <h1 class="color_font font-weight-bold text-center">Proveedores</h1>
        <div class="d-flex justify-content-center mb-5">
          <img src="img/proveedores.png" style="width:165px">
        </div>
        <hr>
        <div class="d-flex justify-content-around my-5 row">
          <a href="proveedores.php" title="Nuevo"><button class="btn color_use text-warning px-md-4 py-md-4 px-xs-3 py-xs-3"><img src="img/plus.png" style="width:100px"></button></a>
