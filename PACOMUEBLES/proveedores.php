...
<body onload="hora_act()">
  ...
  <div class="d-flex" id="wrapper">
    ...
    <!--PHP añadir proveedor-->
      <?php
      if(isset($_POST['btn_insert_proveedor'])){

        include 'conexion.php';
        $idProv = strtoupper($_POST['id_proveedor']);
        $nombre_p = strtoupper($_POST['nombre_proveedor']);
        $nombre_c = strtoupper($_POST['nombre_contacto']);
        ...
        if($resultado === FALSE){
          $sql = $conexion->prepare("INSERT INTO PROVEEDORES(ID_PROVEEDOR,NOMBRE_PROVEEDOR,NOMBRE_CONTACTO,PROVINCIA,CIUDAD,TELEFONO,EMAIL,ESTADO) VALUES(?,?,?,?,?,?,?,?);");
          $resultado = $sql->execute([$idProv,$nombre_p,$nombre_c,$provincia,$ciudad,$telefono,$email,$optionestado]);
          if($resultado === TRUE){
...
<!--modal lista de proveedores-->
    <div class="modal" id="listaProveedores" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="listaProveedoresLabel" aria-hidden="true">
              ...
              <table class="table table-striped table-hover color_font" id="tabla_modal">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="proveedor_editar.php?id=<?php echo $datos->ID_PROVEEDOR;?>"><button title="Editar" class="btn color_use text-warning"><i class="fas fa-edit"></i></button></a></td>
                    <?php
                      $queryEsta = $conexion->query("SELECT * FROM PEDIDOS WHERE ID_PROVEEDOR = '$datos->ID_PROVEEDOR'");
                      $btnEliminar = $queryEsta->fetchALL(PDO::FETCH_OBJ);
                      if($_SESSION['PERMISSION'] == 1 && !$btnEliminar){
                        echo "<td><a href='proveedor_eliminar.php?id=".$datos->ID_PROVEEDOR."'><button title='Eliminar' class='btn btn-outline-danger bg-danger text-white'><i class='fas fa-trash-alt'></i></button></a></td>";   
                      }else{
                        echo "<td></td>";
                      }
                    ?>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control color_font" name="id_proveedor" autocomplete="off" maxlength="5" pattern="^(?:[0-9][0-9]*|0)$" required>
            </div>
          </div>
          <div class="form-group col-md-6">
            <label for="nombre_proveedor">Nombre proveedor:</label>
              <div class="input-group">
                ...
                <input type="text" class="form-control color_font" name="nombre_proveedor" maxlength="100" autocomplete="off" required>
              </div>
            </div>
          </div>
          <div class="form-row">            
            <div class="form-group col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control color_font" name="nombre_contacto" maxlength="50" autocomplete="off">
              </div>
            </div>
            <div class="form-group col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control color_font" name="telefono" maxlength="9" pattern="^(?:[1-9][0-9]*|0)$" autocomplete="off" required>
              </div>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control color_font" name="provincia" maxlength="100" autocomplete="off" required>
              </div>
            </div>
            <div class="form-group col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control color_font" name="ciudad" maxlength="100" autocomplete="off" required>
              </div>
            </div>            
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control color_font" name="email" autocomplete="off" maxlength="100" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" required>
              </div>
            </div>
            <div class="form-group col-md-6">
          ...
          <button type="submit" name="btn_insert_proveedor" title="Añadir" class="btn btn-lg btn-block color_use text-warning"><i class="fas fa-plus"></i></button>           
        </form>
        <div class="container d-flex  justify-content-around mt-2">
          <a href="proveedor_home.php" class="btn color_text bg-warning"><i class="fas fa-arrow-left"></i></a>
          <button class="btn color_text bg-warning" name="lupa-lista" data-toggle="modal" title="Buscar" data-target="#listaProveedores"><i class="fas fa-search"></i></button>
        </div>
      </div>
      <!--/form proveedores-->
    </div>
