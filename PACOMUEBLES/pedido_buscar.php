    ...
    <!--PHP BUSCAR pedidos-->
      <?php   
        if(isset($_POST['searchBtn'])){
          ...
          $select = "SELECT * FROM PEDIDOS WHERE ".$filtro." like '%".$campo."%'";
    ...
    <!-- Lista de pedidos buscadas-->
      <div class="container my-5 color_font">       
        ...
        <form class="form" action="pedido_buscar.php" method="post">
          <div class="container form-row d-flex justify-content-center mb-3">
            ...
            <div class="form-group col-md-4 m-0">
              ...
              <input type="searchInput" class="form-control" name="inputSearch" autocomplete="off">
            </div>
            <div class="form-group col-md-1 m-0">
              <label class="text-white" for="searchInput">boton</label>
              <div class="d-flex justify-content-center">
                <button name="searchBtn" title="Filtrar" class="btn color_text bg-warning color_font" title="Buscar"><i class="fas fa-search"></i></button>    
              </div>
            </div>
          </div>         
        </form> 
        ...
        <div class="container d-flex  justify-content-center mt-2">
          <a class="btn color_text bg-warning" href="pedido_home.php"><i class="fas fa-arrow-left"></i></a>            
        </div>
      </div>      
    </div>
  </div>
